			...
			<div slot="form">
				<form on:submit={addServer}>
					<div class="mb-3">
						...
						<input bind:value={addServerValues.ORTHANC_NAME} type="text" class="form-control rounded-3" id="serverName" placeholder="Ex: cardiology_server_1">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<input bind:value={addServerValues.HOST_NAME_SWARM} type="text" class="form-control rounded-3" id="hostName" placeholder="Ex: OrthancPACS">
					</div>
					<div class="mb-3">
						<label for="webPort" class="form-label fs-5">Port Web:</label>
						<input bind:value={addServerValues.PORTS_WEB} type="text" class="form-control rounded-3" id="webPort" placeholder="Ex: 8083">
					</div>
					<div class="mb-3">
						<label for="DICOMPort" class="form-label fs-5">Port DICOM:</label>
						<input bind:value={addServerValues.PORTS_DICOM} type="text" class="form-control rounded-3" id="DICOMPort" placeholder="Ex: 4243">
					</div>
